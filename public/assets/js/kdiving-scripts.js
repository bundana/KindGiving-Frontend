...
$(document).ready(function () {
    $('.mobile-nav__toggler').click(function () {
        ...
        $('.main-header-four').toggleClass('sticky-header-hidden');
        if ($('.mobile-nav__wrapper').hasClass('open')) {
            $('.main-header-four').removeClass('sticky-header');
        } else {
            // Add the sticky header class back when mobile menu is closed
            if ($(window).scrollTop() > 0 && $(window).width() <= 767) {
                $('.main-header-four').addClass('sticky-header');
            }
        }
    });
    ...
    $(window).scroll(function () {
        ...
        if (scroll > lastScrollTop && $(window).width() <= 767 && !$('.mobile-nav__wrapper')
            .hasClass('open')) {
            $('.main-header-four').addClass('sticky-header');
        } else {
            $('.main-header-four').removeClass('sticky-header');
