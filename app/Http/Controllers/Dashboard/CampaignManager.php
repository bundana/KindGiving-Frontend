...
class CampaignManager extends Controller
{
    ...
    public function campaignIndex(Request $request)
    {
        ...
        return view('manager.campaigns.index', compact('campaigns', 'keyword', 'status'));
    }

    public function newCampaignIndex()
    {
        return view('manager.campaigns.new');
    }
    public function updateCampaignIndex(Request $request)
    {
        ...
        return view('manager.campaigns.edit')->with('campaign', $campaign);
    }
    ...
    public function viewCampaign(Request $request)
    {
        ...
        $donations = Donations::where('campaign_id', $campaign_id)->latest()
        ->paginate(50);
        ...
        return view('manager.campaigns.view')
    ...
    public function allAgents(Request $request)
    {
        ...
        $campaigns = Campaign::where('manager_id', auth()->user()->user_id)
            ...
            ->latest()
            ->paginate(50);
        return view('manager.campaigns.all-agents', compact('campaigns', 'keyword', 'status'));
    }
    public function campaignAgents(Request $request)
    {
        ...
        $agents = CampaignAgent::with('user')
            ...
            ->paginate(50);
        // Render the 'view' template and pass the campaign, donations, and agents data
        return view('manager.campaigns.campaign-agents')
            ->with('campaign', $campaign)
    ...
    public function viewAgent(Request $request)
    {
        ...
        return view('manager.campaigns.view-agent')
            ->with('campaign', $campaign)
            ->with('agent', $agent)
            ->with('donations', $donations)
    ...
    public function allDonors(Request $request)
    {
        ...
        $campaigns = Campaign::where('manager_id', auth()->user()->user_id)
            ...
            ->latest()
            ->paginate(50);
        return view('manager.campaigns.all-donors', compact('campaigns', 'keyword', 'status'))->with('status', $status)->with('keyword', $keyword);
    }
    ...
    public function campaignDonors(Request $request)
    {
        ...
        // Render the 'view' template and pass the campaign, donations, and agents data
        return view('manager.campaigns.campaign-donors')
            ->with('campaign', $campaign)
    ...
    public function donationsReceipt(Request $request)
    {
        ...
        $campaigns = Campaign::where('manager_id', auth()->user()->user_id)
            ...
            ->latest()
            ->paginate(50);
        return view('manager.campaigns.all-receipts')->with('campaigns', $campaigns)->with('status', $status)->with('keyword', $keyword);
    }
    ...
    public function newDonationsReceiptIndex(Request $request)
    {
        ...
        return view('manager.campaigns.new-receipt')->with('campaign', $campaign);
    }
    ...
    public function camapaignReceiptIndex(Request $request)
    {
        ...
        // Render the 'view' template and pass the campaign, donations, and agents data
        return view('manager.campaigns.campaign-receipts')
            ->with('campaign', $campaign);
    }
    ...
    public function payReceiptIndex(Request $request)
    {
        ...
        return view('manager.campaigns.pay-donation-receipts')->with('campaign', $campaign);
    }
    ...
    public function donationsStats(Request $request)
    {
        ...
        $campaigns = Campaign::where('manager_id', auth()->user()->user_id)
            ...
            ->latest()
            ->paginate(50);
        return view('manager.campaigns.donations-reports-index')->with('campaigns', $campaigns)->with('status', $status)->with('keyword', $keyword);
    }
    ...
    public function viewDonationsStats(Request $request)
    {
        ...
        return view(
            'manager.campaigns.all-donations-reports',
    ...
    public function paymentLinksIndex(Request $request)
    {
        ...
        $campaigns = Campaign::where('manager_id', auth()->user()->user_id)
            ...
            ->latest()
            ->paginate(50);
        return view('manager.campaigns.payment-links-index', compact('campaigns', 'keyword', 'status'))->with('status', $status)->with('keyword', $keyword);
    }
    ...
    public function paymentLinksForm(Request $request)
    {
        ...
        return view('manager.campaigns.payment-links-form')->with('campaign', $campaign);
    }
    ...
    public function paymentLinkDirectIndex(Request $request)
    {
        ...
        $campaigns = Campaign::where('manager_id', auth()->user()->user_id)
            ...
            ->latest()
            ->paginate(50);
        return view('manager.campaigns.web-payment-index', compact('campaigns', 'keyword', 'status'))->with('status', $status)->with('keyword', $keyword);
    }
    ...
    public function paymentLinkDirectForm(Request $request)
    {
        ...
        return view('manager.campaigns.web-payment-form')->with('campaign', $campaign);
    }
}
